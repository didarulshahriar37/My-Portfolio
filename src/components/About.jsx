    ...
    return (
        <section id="about" className="w-11/12 mx-auto my-20 scroll-mt-40">
            <div className="mx-auto p-8 rounded-2xl mt-10">
                ...
                <h2 className="text-2xl sm:text-4xl font-extrabold text-gray-800 dark:text-gray-100 mb-10 text-center">
                    About Me
                </h2>

                <p className="text-base md:text-left text-center sm:text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                ...
                <p className="text-base sm:text-lg text-gray-700 md:text-left text-center dark:text-gray-300 leading-relaxed mb-6">
                ...
                <p className="text-base sm:text-lg text-gray-700 dark:text-gray-300 md:text-left text-center leading-relaxed mb-6">
                ...
                <p className="text-base sm:text-lg text-gray-700 dark:text-gray-300 leading-relaxed md:text-left text-center">
